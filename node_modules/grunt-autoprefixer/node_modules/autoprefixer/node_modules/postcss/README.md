...
```js
var wrong = "a {";
processor.process(wrong, { from: 'styles.css' });
//=> Can't parse CSS: Unclosed block at line 1:1 in styles.css
```
### Source Map
...
result.map //=> '{"version":3,"file":"main.out.css","sources":["styles.css"],"names":[],"mappings":"AAAA,KAAI"}'
...
```
var root = postcss.parse(css, { from: 'styles.css' });
var rule = root.rules[1];

rule.source.file  //=> 'styles.css'
